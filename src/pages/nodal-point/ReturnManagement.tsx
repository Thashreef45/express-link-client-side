...
const ReturnSending = () => {
    ...
    const transferFdm = (id: string) => {
        NodalInstance.post(NODAL_API.return_sending_fdm,{id:id}).then(()=>{
    ...
    const setFdmsData = () => {
        NodalInstance.get(NODAL_API.return_sending_fdms).then((res) => {
    ...
    return (
        <>
          ...
          onClick={() => navigate('/nodal/return-recieved')}
        >
          Return recieved
        </Button>
